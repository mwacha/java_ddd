...
class OrderServiceTest {
    ...
    void should_get_total_of_all_orders() {
        ...
        final var item = new OrderItem(UUID.randomUUID(), UUID.randomUUID(), "Item 1", BigDecimal.valueOf(100), 1);
        final var item2 = new OrderItem(UUID.randomUUID(), UUID.randomUUID(), "Item 2", BigDecimal.valueOf(200), 2);
    ...
    void should_place_an_order() {
        ...
        final var item = new OrderItem(UUID.randomUUID(), UUID.randomUUID(), "Item 1", BigDecimal.valueOf(10), 1);
